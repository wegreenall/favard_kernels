...
"""
This file contains code that will read the data of the experiment_10_data/single_training,
...
def read_files(
    ...
    gaussian_file = "exp_10_gaussian_parameters_" + str(number) + ".pt"
    non_gaussian_file = "exp_10_non_gaussian_parameters_" + str(number) + ".pt"
    favard_file = "exp_10_favard_parameters_" + str(number) + ".pt"
    try:
...
if __name__ == "__main__":
    ...
    if gaussian_test:
        prefix = "/home/william/phd/programming_projects/favard_kernels/experiments/experiment_10_data/single_training/"
    else:
        prefix = "/home/william/phd/programming_projects/favard_kernels/experiments/experiment_10_data/single_training/non_gaussian_test_input_dist/"
