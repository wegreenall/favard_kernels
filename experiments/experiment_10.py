...
def get_latest_experiment_number():
    files = os.listdir("./experiment_10_data/")
    numbers = []
...
for i in range(start_number + 1, experiment_count):
    ...
    if train_gaussian:
        ...
        gaussian_saves = (
            "./experiment_10_data/single_training/exp_10_gaussian_parameters_"
            + str(i)
            + ".pt"
        )
    ...
    if train_non_gaussian:
        ...
        non_gaussian_saves = (
            "./experiment_10_data/single_training/exp_10_non_gaussian_parameters_"
            + str(i)
            + ".pt"
        )
    ...
    if train_favard:
        ...
        favard_saves = (
            "./experiment_10_data/single_training/exp_10_favard_parameters_"
            + str(i)
            + ".pt"
        )
